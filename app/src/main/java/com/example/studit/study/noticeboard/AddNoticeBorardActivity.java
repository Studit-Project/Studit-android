...
public class AddNoticeBorardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_notice_board_add);

        // NoticeBoardActivity 에서 넘긴 userid 를 변수로 받음
        userid = getIntent().getStringExtra("userid");

        // 컴포넌트 초기화
        title_et = findViewById(R.id.notice_title_tv);
        content_et = findViewById(R.id.notice_et);
        reg_button = findViewById(R.id.regi_button);
