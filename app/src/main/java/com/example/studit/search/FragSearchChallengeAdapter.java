...
public class FragSearchChallengeAdapter extends RecyclerView.Adapter<FragSearchChallengeAdapter.FragSearchChallViewHolder> {
    ...
    public class FragSearchChallViewHolder extends RecyclerView.ViewHolder {
        public TextView state, title, tag, progress;

        public FragSearchChallViewHolder(View view) {
            super(view);
            ...
            this.progress = view.findViewById(R.id.list_search_challenge_progress);
...
//                    context.startActivity(intent);
    ...
    @NonNull
    @Override
    public FragSearchChallViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View cardView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_frag_search_challenge, parent, false);
        FragSearchChallViewHolder holder = new FragSearchChallViewHolder(cardView);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull FragSearchChallViewHolder holder, int position) {
